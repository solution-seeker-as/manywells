...
for i, fn in enumerate(files):
    ...
    c_dict = {
        ...
        'ns_bhv.lifetime': c.ns_bhv.lifetime,
        'ns_bhv.pr_init': c.ns_bhv.pr_init,
        'ns_bhv.ps_init': c.ns_bhv.ps_init,
        'ns_bhv.pr_conv': c.ns_bhv.pr_conv,
        'ns_bhv.eps': c.ns_bhv.eps,
        'ns_bhv.decay_rate': c.ns_bhv.decay_rate,
        'ns_bhv.decay_rate_noise_factor': c.ns_bhv.decay_rate_noise_factor,
        'ns_bhv.init_fractions': c.ns_bhv.init_fractions,
        'ns_bhv.decay_g': c.ns_bhv.decay_g,
        'ns_bhv.decay_o': c.ns_bhv.decay_o,
        # ----------------------------------
    }
    if 'last_x' in obj:
